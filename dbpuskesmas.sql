...
--
ALTER TABLE `pasien` ADD PRIMARY KEY (`id`), ADD KEY `kelurahan_id` (`kelurahan_id`);
...
--
ALTER TABLE `kelurahan` MODIFY `id` INT(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT untuk tabel `pasien`
--
ALTER TABLE `pasien` MODIFY `id` INT(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `pasien` ADD CONSTRAINT `pasien_ibfk_1` FOREIGN KEY (`kelurahan_id`) REFERENCES `kelurahan` (`id`); COMMIT;
